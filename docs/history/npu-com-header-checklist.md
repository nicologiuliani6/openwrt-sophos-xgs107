> **Superseded.** The NPU console is the x86's `/dev/ttyS2` @ 115200; this header was never needed. Kept for the record.
...
> [bench-log.md](development-log.md) §3). This checklist is kept as a fallback.
...
From the r/opnsense thread (see [prior-art.md](../reference/prior-art.md)); one unit,
...
**Observed on our unit (2026-09-18, photo `../img/npu-com-header.jpg`):**
