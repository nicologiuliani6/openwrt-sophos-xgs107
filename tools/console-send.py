...
import glob
default_dev = (glob.glob('/dev/serial/by-id/usb-Prolific*-port0') or ['/dev/ttyUSB0'])[0]
p.add_argument('--dev', default=default_dev,
               help='x86 console: the PL2303 by-id node (survives ttyUSBn renumbering), else /dev/ttyUSB0')
